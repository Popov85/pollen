...
import ua.edu.zsmu.mfi.biology.pollen.weather.ForecastWeatherJSONParser;
...
public class ForecastWeatherJSONParserInstrumentedTest {
    ...
    private double getAVGPressureExpected() {
        ...
        for (double v : PRESSURE_OF_DAY_20170520) {
            sum+=v* ForecastWeatherJSONParser.MM_OF_MERCURY_CONST;
            counter++;
        }
        return sum/counter;
    }
